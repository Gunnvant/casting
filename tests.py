...
casting_assistant_auth_header = {"Authorization": bearer_tokens["casting_assistant"]}

casting_director_auth_header = {"Authorization": bearer_tokens["casting_director"]}

executive_producer_auth_header = {"Authorization": bearer_tokens["executive_producer"]}
...
class CastingTestCase(unittest.TestCase):
    ...
    def test_get_actors(self):
        ...
        res = self.client().get("/api/actors", headers=executive_producer_auth_header)
    ...
    def test_get_movies(self):
        ...
        res = self.client().get("/api/movies", headers=executive_producer_auth_header)
        data = json.loads(res.data)
    ...
    def test_actors_patch(self):
        ...
        res = self.client().patch(
            f"/api/actors/{id}", json=payload, headers=executive_producer_auth_header
        )
        data = json.loads(res.data)
    ...
    def test_movies_patch(self):
        ...
        ## Hit the patch endpoint
        res = self.client().patch(
            f"/api/movies/{id}", json=payload, headers=executive_producer_auth_header
        )
        data = json.loads(res.data)
    ...
    #############################################################################
    # Tests for Casting Director, this role doesn't have access to /POST/movies #
    #############################################################################
    ...
    def test_casting_director_get_movies(self):
        ...
        ## Hit the GET/actors endpoint
        res = self.client().get("/api/actors", headers=casting_director_auth_header)
        data = json.loads(res.data)
    ...
    def test_casting_assistant_get_actors(self):
        ...
        ## Hit the GET/actors endpoint
        res = self.client().get("/api/actors", headers=casting_assistant_auth_header)
        data = json.loads(res.data)
